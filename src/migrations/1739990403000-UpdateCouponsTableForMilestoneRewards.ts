...
export class UpdateCouponsTableForMilestoneRewards1739990403000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "coupons" DROP COLUMN IF EXISTS "xlmValue"`);
    ...
    await queryRunner.query(`ALTER TABLE "coupons" ALTER COLUMN "expiresAt" SET NOT NULL`);
    ...
    await queryRunner.query(`ALTER TABLE "coupons" ALTER COLUMN "code" TYPE varchar(8)`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "coupons" DROP COLUMN IF EXISTS "discount"`);
    await queryRunner.query(`ALTER TABLE "coupons" DROP COLUMN IF EXISTS "specialistType"`);
    await queryRunner.query(
      `ALTER TABLE "coupons" ADD COLUMN IF NOT EXISTS "xlmValue" decimal(10,2) NULL`
    );
    await queryRunner.query(`ALTER TABLE "coupons" ALTER COLUMN "code" TYPE varchar(50)`);
    await queryRunner.query(`ALTER TABLE "coupons" ALTER COLUMN "expiresAt" DROP NOT NULL`);
  }
}
